...
exports.generateRoomWithoutSeparator = void 0;
...
function generateRoomWithoutSeparator() {
    var name = randomUtil_1.randomElement(PATTERNS);
    while (_hasTemplate(name)) {
        for (var template in CATEGORIES) {
            var word = randomUtil_1.randomElement(CATEGORIES[template]);
...
//# sourceMappingURL=roomNameGenerator.js.map